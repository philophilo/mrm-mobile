...
/**
 * MeetingRoomActivity UI/Instrumentation Test.
 */
@LargeTest
@RunWith(AndroidJUnit4.class)
public class MeetingRoomActivityInstrumentationTest {
    // TODO: uncomment statement once firebase test-lab issues are fixed.
//    public UiDevice mDevice;

    @Rule
    public IntentsTestRule<MeetingRoomActivity> mActivityTestRule =
            new IntentsTestRule<>(MeetingRoomActivity.class, true, false);
